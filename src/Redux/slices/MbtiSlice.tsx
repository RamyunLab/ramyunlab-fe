...
const calculateMBTI = (answers: string[]) => (dispatch: any) => {
    ...
    const ramenRecommendationMap = {
        ENTJ: {
            ...
            imageUrl: "https://dc7ne3bdq944q.cloudfront.net/img/ramyun/삼양_왕뚜껑.jpg",
        },
        ENTP: {
            ramen: "신라면",
            description:
        ...
        ESFJ: {
            ...
            imageUrl: "https://dc7ne3bdq944q.cloudfront.net/img/ramyun/농심_새우탕.jpg",
        },
        ENFJ: {
            ramen: "육개장",
            description:
                "카리스마 넘치는 ENFJ는 사람들을 돕는 것을 좋아하며, 육개장의 강렬하고 따뜻한 맛이 그들에게 잘 어울립니다.",
            imageUrl: "https://dc7ne3bdq944q.cloudfront.net/img/ramyun/농심_육개장.jpg",
        },
        ENFP: {
            ramen: "불닭볶음면",
            description:
        ...
        ESTP: {
            ...
            imageUrl: "https://dc7ne3bdq944q.cloudfront.net/img/ramyun/농심_짜파게티.jpg",
        },
        ESFP: {
            ramen: "짜왕",
            description:
        ...
        INTJ: {
            ...
            imageUrl: "https://dc7ne3bdq944q.cloudfront.net/img/ramyun/오뚜기_진라면.jpg",
        },
        INTP: {
            ramen: "참깨라면",
            description:
                "논리적이고 호기심 많은 INTP는 새로운 아이디어를 탐구하며, 참깨라면의 고소하고 독특한 맛을 즐깁니다.",
            imageUrl: "https://dc7ne3bdq944q.cloudfront.net/img/ramyun/농심_참깨라면.jpg",
        },
        INFJ: {
            ramen: "비빔면",
            description:
                "직관적이고 통찰력 있는 INFJ는 깊이 있는 의미를 찾으며, 비빔면의 매콤달콤한 맛과 어울립니다.",
            imageUrl: "https://dc7ne3bdq944q.cloudfront.net/img/ramyun/농심_비빔면.jpg",
        },
        INFP: {
            ramen: "사리곰탕",
            description:
        ...
        ISTP: {
            ...
            imageUrl: "https://dc7ne3bdq944q.cloudfront.net/img/ramyun/농심_너구리.jpg",
        },
        ISFP: {
            ramen: "삼양라면",
            description:
